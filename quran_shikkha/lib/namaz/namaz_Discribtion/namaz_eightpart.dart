...
class namaz_eightpart extends StatefulWidget {
  const namaz_eightpart({Key? key}) : super(key: key);

  @override
  State<namaz_eightpart> createState() => _namaz_eightpartState();
}

class _namaz_eightpartState extends State<namaz_eightpart> {
  @override
