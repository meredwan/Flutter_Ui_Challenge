...
class namaz_sevenpart extends StatefulWidget {
  const namaz_sevenpart({Key? key}) : super(key: key);

  @override
  State<namaz_sevenpart> createState() => _namaz_sevenpartState();
}

class _namaz_sevenpartState extends State<namaz_sevenpart> {
  @override
